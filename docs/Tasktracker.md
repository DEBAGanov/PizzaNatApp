...
- **Шаги выполнения**:
  ...
  - [ ] Ожидание готовности Admin API (возвращает 500 ошибки)
  - [ ] Ожидание готовности Notification API (возвращает 500 ошибки)
